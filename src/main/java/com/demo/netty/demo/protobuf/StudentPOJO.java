...
public final class StudentPOJO {
    ...
    public static final class Student extends
        ...
        public static final class Builder extends
            ...
            public Builder mergeFrom(StudentPOJO.Student other) {
                if (other == StudentPOJO.Student.getDefaultInstance()) {
                    return this;
                }
                if (other.getId() != 0) {
                    setId(other.getId());
    ...
    static {
        ...
        com.google.protobuf.Descriptors.FileDescriptor[] fileDescriptors =  new com.google.protobuf.Descriptors.FileDescriptor[] {};
        descriptor = com.google.protobuf.Descriptors.FileDescriptor
                .internalBuildGeneratedFileFrom(descriptorData, fileDescriptors);
        internal_static_Student_descriptor =
